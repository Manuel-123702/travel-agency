...
import {
  Phone, Mail, MapPin, Facebook, Instagram, Linkedin, Youtube, ArrowRight,
} from "lucide-react";
...
export default function Footer() {
  return (
    <footer className="bg-navy text-white">
      {/* Newsletter band */}
      <div className="bg-gradient-to-r from-blue-900 to-[#1E40AF] py-10">
            ...
            <div className="flex items-center gap-2 mt-6 flex-wrap">
              {socials.map(({ icon: Icon, href, label, color }) => (
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label={label}
                  className={`w-9 h-9 rounded-full border border-white/20 flex items-center justify-center text-white/50 transition-all duration-200 ${color}`}
                >
                  <Icon />
                </a>
              ))}
          ...
          <div>
            ...
            <div className="space-y-3">
              {["IATA Certified", "RCIC Registered", "ISO 9001:2015", "AIRC Member"].map((cert) => (
                <div key={cert} className="flex items-center gap-2 text-sm text-white/60">
            ...
            <div className="mt-8 p-4 rounded-xl border border-white/10 bg-white/5">
              ...
              <div className="text-white/60 text-xs mt-0.5">Cases Processed</div>
              <div className="text-gold font-heading font-bold text-2xl mt-3">10+</div>
              <div className="text-white/60 text-xs mt-0.5">Years Experience</div>
            </div>
          </div>
        </div>
      </div>
