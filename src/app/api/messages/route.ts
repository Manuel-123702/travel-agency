...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!sender) return unauthorizedResponse("User not found");
    ...
    if (!receiver) return badRequestResponse("Receiver not found");
    ...
    await db.conversation.update({
      ...
      data: { lastMessage: validatedData.content, lastMessageAt: new Date() },
    });
