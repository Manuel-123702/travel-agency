...
import { Globe, Search, Filter, Plus } from "lucide-react";
  ...
  return (
    <div className="p-6 md:p-8 max-w-7xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
          <h1 className="font-heading font-bold text-2xl md:text-3xl text-navy">Countries</h1>
          <p className="text-gray-500 mt-1">Manage destination countries and their requirements</p>
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="p-8 text-center text-gray-500">
          ...
          <p className="font-medium">No countries configured</p>
          <p className="text-sm mt-1">Add countries to manage their visa requirements</p>
        </div>
      </div>
    </div>
  );
