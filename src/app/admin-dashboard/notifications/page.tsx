  ...
  return (
    <div className="p-6 md:p-8 max-w-7xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
          <h1 className="font-heading font-bold text-2xl md:text-3xl text-navy">Notifications</h1>
          <p className="text-gray-500 mt-1">Manage system-wide notifications and alerts</p>
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="p-8 text-center text-gray-500">
          ...
          <p className="text-sm mt-1">Send notifications to keep users informed</p>
        </div>
      </div>
    </div>
  );
