          ...
          >
            ...
            <div className="space-y-2">
              <Link
                ...
                className="w-full flex items-center justify-center gap-2 bg-navy text-white font-semibold py-2.5 rounded-xl text-sm hover:bg-blue-800 transition-colors"
              >
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-white/60 text-sm mt-0.5">
              Canada 🇨🇦 (Primary) · France 🇫🇷 (Secondary)
            </p>
          </div>
        </div>
        <Link
          href="/dashboard/case"
          className="flex-shrink-0 flex items-center gap-2 bg-gold text-navy font-heading font-bold px-6 py-3 rounded-full hover:shadow-xl hover:shadow-gold/30 hover:-translate-y-0.5 transition-all text-sm"
        >
